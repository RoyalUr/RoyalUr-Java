...
> {
    ...
    /**
     * Copies this game builder with the dice to be used to generate dice
     * rolls set to {@code dice}.
     * @param diceFactory The generator of dice to be used to generate
     *                    dice rolls.
     * @param <NEW_R> The type of the dice rolls generated by {@code dice}.
     * @return A copy of this game builder with the dice to be used to
     *         generate dice rolls set to {@code dice}.
     */
     ...
     * The rules do not contain any player identification information set in
     * this builder.
     * @return A standard rule set to match the settings in this builder.
     */
    public @Nonnull RuleSet<P, S, R> buildRules() {
        return ruleSetProvider.create(settings, new GameMetadata());
    }
