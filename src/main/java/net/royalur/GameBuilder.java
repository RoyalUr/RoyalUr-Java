...
public class GameBuilder {
    ...
    public static abstract class BaseSimpleGameBuilder<R extends Roll, SELF extends BaseSimpleGameBuilder<R, SELF>> {
        ...
        /**
         * Copies this game builder with the shape of the board set to {@param boardShape}.
         * @param boardShape The shape of the board to use for generated games.
         * @return A copy of this game builder with the shape of the board set to {@param boardShape}.
         */
        ...
        /**
         * Copies this game builder with the paths taken by each player set to {@param paths}.
         * @param paths The paths to be taken by each player.
         * @return A copy of this game builder with the paths taken by each player set to {@param paths}.
         */
        ...
        /**
         * Copies this game builder with the dice to be used to generate dice rolls set to {@param dice}.
         * @param dice The dice to be used to generate dice rolls.
         * @param <NR> The type of the dice rolls generated by {@param dice}.
         * @return A copy of this game builder with the dice to be used to generate dice rolls set to {@param dice}.
         */
         ...
         * set to {@param startingPieceCount}.
        ...
        /**
         * Copies this game builder with the name of the light player set to {@param lightPlayerName}.
         * @param lightPlayerName The name of the light player.
         * @return A copy of this game builder with the name of the light player set to {@param lightPlayerName}.
         */
        ...
        /**
         * Copies this game builder with the name of the dark player set to {@param darkPlayerName}.
         * @param darkPlayerName The name of the dark player.
         * @return A copy of this game builder with the name of the dark player set to {@param darkPlayerName}.
         */
        ...
        /**
         * Generates a player state using {@param rules} for {@param player} that may or may not have a name,
         * depending on whether {@param name} is {@code null}.
         ...
         * @return A player state representing {@param player}, that may be named.
         */
